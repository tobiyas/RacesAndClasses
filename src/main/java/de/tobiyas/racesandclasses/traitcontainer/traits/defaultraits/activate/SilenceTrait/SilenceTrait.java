package de.tobiyas.racesandclasses.traitcontainer.traits.defaultraits.activate.SilenceTrait;
...
public class SilenceTrait extends AbstractBasicTrait {
	...
	@TraitInfos(category="activate", traitName="SilenceTrait", visible=true)
	@Override
	...
	public boolean isBetterThan(Trait trait) {
		if(trait instanceof SilenceTrait) return duration > ((SilenceTrait) trait).duration;
		return false;
	}
