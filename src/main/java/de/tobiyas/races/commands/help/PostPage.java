...
public class PostPage {
	...
	private static void page1(CommandSender sender){
		...
		sender.sendMessage(ChatColor.GREEN + "/playerinfo [player-name] " + ChatColor.YELLOW + "displays infos to a player.");
		sender.sendMessage(ChatColor.GREEN + "/racestutorial <start/stop/next>" + ChatColor.YELLOW + "gives you a step by step tutorial of the Plugin.");
	}
	...
	private static void page4(CommandSender sender){
		...
		int range = Races.getPlugin().getChannelConfig().getConfig_localchat_range();
